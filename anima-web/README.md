...
1. Push this `zenbu-web` folder to its own GitHub repository (separate
...
5. Click **Deploy**. You'll get a live URL like `https://zenbu-web.vercel.app`.
...
(e.g. `https://zenbu-web.vercel.app`). Right now the API accepts requests
